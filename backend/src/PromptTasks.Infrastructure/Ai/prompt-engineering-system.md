...
- Diretório de trabalho: @src/PromptTasks.Application
```
...
dotnet test backend/PromptTasks.sln --filter "WorkspaceTests"
```
...
```
Analise @src/PromptTasks.Application/Features/Prompts/Commands/CreatePrompt/CreatePromptHandler.cs
...
- @src/PromptTasks.Domain/Common/AuditableEntity.cs — classe base
- @src/PromptTasks.Infrastructure/Persistence/ApplicationDbContext.cs — adicionar DbSet
- @src/PromptTasks.Application/Common/Interfaces/IApplicationDbContext.cs — adicionar interface

Arquivos a criar:
- src/PromptTasks.Domain/Notifications/Notification.cs
- src/PromptTasks.Application/Features/Notifications/...
```
...
Comando: `dotnet ef migrations add Add[Descrição] --project backend/src/PromptTasks.Infrastructure --startup-project backend/src/PromptTasks.Api`
...
```
Revise @src/PromptTasks.Application/Features/Ai/Commands/SendChatMessage/SendChatMessageHandler.cs
focando em:
...
```
## Contexto
Projeto: PromptTasks — Clean Architecture, MediatR CQRS, ASP.NET Core
