...
using Thoth.Application.Features.Ai.Queries.GetAiSettings;
using Thoth.Application.Features.Ai.Queries.GetChatSession;
using Thoth.Application.Features.Ai.Queries.ListChatSessions;
