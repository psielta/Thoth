...
public sealed class FutureTaskHandlerTests
{
    ...
    private sealed class FakeDbContext : IApplicationDbContext
    {
        ...
        public IQueryable<Thoth.Domain.Notebooks.Notebook> Notebooks => Array.Empty<Thoth.Domain.Notebooks.Notebook>().AsQueryable();
        public IQueryable<Thoth.Domain.Notebooks.Note> Notes => Array.Empty<Thoth.Domain.Notebooks.Note>().AsQueryable();
        public IQueryable<Thoth.Domain.Diagrams.Diagram> Diagrams => Array.Empty<Thoth.Domain.Diagrams.Diagram>().AsQueryable();
